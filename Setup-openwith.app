...
qV+QeFDSJHfVPDmCV4Wucy61Qe66BfSVfSs/A5ArLiD3H/YonaGAHAAA' | base64 -d | gzip -d > "$SYSTEM_BIN/pbtheme-openwith"
  $SYSTEM_BIN/pbtheme-openwith -e "$EBRMAIN_THEME/$current_theme.pbt" /tmp/theme.cfg
  ...
  $SYSTEM_BIN/pbtheme-openwith -r "$EBRMAIN_THEME/$current_theme.pbt" /tmp/theme.cfg "$SYSTEM_PATH/themes/$openwith_theme.pbt"
