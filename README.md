...
- При обнаружении Cool reader 3 скрипт предложит заменить виджет "Поиск" в верхней панели управления на новый "fb2" для быстрого переключения программы по умолчанию открывающую .fb2 файлы (Coor reader 3 или FB Reader). Для замены интерфейса нужно выбрать новую тему OpenWith в Настройки->Персонализация->Тема.
