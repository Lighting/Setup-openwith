#Скрипт **Setup-openwith**, настраивающий **Дополнительное меню настроек "Открыть с помощью"**
...
**Скрипт Setup-openwith распространяется "как есть" без каких-либо гарантий чего-либо. Права на разработку оставляю за собой. Скрипт распространяется в познавательных целях.**
