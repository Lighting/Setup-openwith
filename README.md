...
Совместим с PocketBook 650 и другими похожими моделями. (Несовместимость скорее всего может проявляться в виде не локализованного текста на старых прошивках) 
